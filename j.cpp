...
int main () {
	...
	printf ("coordinates of the first black figure. Enter 4 numbers:");
	scanf (" %d %d %d %d", &x3, &x4, &y3, &y4);
	printf ("coordinates of the second black figure. Enter 4 numbers:");
...
if (x1>=x3 && x2<=x4 && y1>=y3 && y2<=y4) {
	...
	if (x1>=x3 && x2>=x4 && y1>=y3 && y2<=y4 &&   x4<=x5 && x2<=x6 && y1>=y5 && y2<=y6) {
	 ...
	 else { 	if (x1>=x3 && x2>=x4 && y1>=y3 && y2<=y4 &&   x4>=x5 && x2<=x6 && y1>=y5 && y2<=y6) {
   	printf("Yes");
	}
	else {
	...
	else {	if (x1>=x3 && x2<=x4 && y2>=y3 && y1<=y5 &&   x1>=x5 && x2<=x6 && y4>=y5 && y2<=y6) {
   	printf("Yes");	
	} 	
	else {
	printf("No");
